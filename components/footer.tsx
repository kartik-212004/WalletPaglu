...
export default function Footer() {
  return (
    <motion.div
      ...
      className="border-t flex flex-row items-center dark:text-gray-400 space-x-2 dark:border-[#434952] tracking-wide font-semibold text-lg w-[55%] container mx-auto bottom-0 "
    >
      <span>
        Developed By{" "}
        <Link
